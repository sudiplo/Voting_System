<x-defult_layout>
    ...
    <header class="w-full glass px-6 py-4 flex justify-between items-center shadow-xl">
        <div class="flex items-center gap-4">
            ...
            <a href="{{ Route('citizen.registerView') }}" class="text-2xs text-gray-500 hover:text-blue-500">Registration</a>
        </div>
    </header>
    ...
    <div class="max-w-5xl mx-auto my-10 p-8 bg-white rounded-xl shadow-lg">
        ...
        <div class="mb-10 text-center">
            <h1 class="text-4xl font-extrabold text-gray-800">
                Nepal <span class="text-indigo-600">Citizenship</span> Registration
            </h1>
            <p class="mt-2 text-gray-500">
                Official citizen record entry (Admin Only)
            </p>
        </div>
