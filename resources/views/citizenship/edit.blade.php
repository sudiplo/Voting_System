    ...
    <div class="max-w-5xl mx-auto my-10 p-8 bg-white rounded-xl shadow-lg">
        ...
        <form action="{{ Route('citizen.update', $citizen->id) }}" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-6" enctype="multipart/form-data">
            ...
            <div>
                ...
                <input type="text" name="nepaliName" value="{{ $citizen->name_nepali }}" class="w-full mt-2 p-3 border rounded-lg focus:ring-2 focus:ring-blue-400 hover:border-blue-500 transition" required>
            </div>

            <!-- Full Name in English -->
            <div>
                <label class="block text-sm font-semibold text-gray-700">Full Name in English:</label>
                <input type="text" name="nameEnglish" value="{{ $citizen->name_english }}" class="w-full mt-2 p-3 border rounded-lg focus:ring-2 focus:ring-blue-400 hover:border-blue-500 transition" required>
            </div>

            <!-- Citizenship Number -->
            <div>
                <label class="block text-sm font-semibold text-gray-700">ना॰प्र॰नं॰:</label>
                <input type="number" name="citizenshipNumber" value="{{ $citizen->citizenship_number }}" class="w-full mt-2 p-3 border rounded-lg focus:ring-2 focus:ring-blue-400 hover:border-blue-500 transition" placeholder="नागरिकताको नं." required>
            </div>

            <!-- Father's Name -->
            <div>
                <label class="block text-sm font-semibold text-gray-700">बाबुको नाम थर :</label>
                <input type="text" name="fatherName" value="{{ $citizen->father }}" class="w-full mt-2 p-3 border rounded-lg focus:ring-2 focus:ring-blue-400 hover:border-blue-500 transition" required>
            </div>

            <!-- Mother's Name -->
            <div>
                <label class="block text-sm font-semibold text-gray-700">आमाको नाम थर:</label>
                <input type="text" name="motherName" value="{{ $citizen->mother }}" class="w-full mt-2 p-3 border rounded-lg focus:ring-2 focus:ring-blue-400 hover:border-blue-500 transition" required>
            </div>

            <!-- Date of Birth -->
            <div>
                <label class="block text-sm font-semibold text-gray-700">जन्म मितिः</label>
                <input type="date" name="dob" value="{{ $citizen->dob }}" class="w-full mt-2 p-3 border rounded-lg focus:ring-2 focus:ring-blue-400 hover:border-blue-500 transition" required>
            </div>

            <!-- Gender -->
            <div>
                <label class="block text-sm font-semibold text-gray-700">लिङ्ग:</label>
                <select name="gender" class="w-full mt-2 p-3 border rounded-lg focus:ring-2 focus:ring-blue-400 hover:border-blue-500 transition">
            ...
            <div>
                ...
                <select name="cardType" class="w-full mt-2 p-3 border rounded-lg focus:ring-2 focus:ring-blue-400 hover:border-blue-500 transition">
            ...
            <div>
                ...
                <div class="mt-2 p-3">
                    <div class="p-2">
                        ...
                        <select id="districtSelect" name="district_id" class="w-full border rounded px-4 py-2">
                    ...
                    <div class="p-2">
                        ...
                        <select id="palikaSelect" name="palika_id" class="w-full border rounded px-4 py-2" disabled>
                    ...
                    <div class="p-2">
                        ...
                        <select id="wardSelect" name="ward_id" class="w-full border rounded px-4 py-2" disabled>
            ...
            <div>
                ...
                <input type="text" name="partner" value="{{ $citizen->partner }}" class="w-full mt-2 p-3 border rounded-lg focus:ring-2 focus:ring-blue-400 hover:border-blue-500 transition">
            </div>

            <!-- Photo Upload -->
            <div>
                <label class="block text-sm font-semibold text-gray-700">Photo Upload</label>
                <input type="file" name="photo" class="w-full mt-2 p-3 border rounded-lg hover:border-blue-500 transition">
            </div>
            ...
            if (palika) {
                ...
                palika.wards.forEach(w => {
                    wardSelect.innerHTML += `
                        <option value="${w.id}">Ward ${w.number} - ${w.name}</option>
                    `;
                });
            } else {
                wardSelect.disabled = true;
