            ...
            <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                <div>
                    <h2 class="text-2xl font-extrabold text-gray-800 tracking-tight">
                        <span class="text-indigo-600">{{ $election->title }} को निर्वाचन परिणाम हेर्नुहोस्</span>
                    </h2>
                    <p class="mt-2 text-gray-500">
                        तपाईं विभिन्न क्षेत्रहरूको मतदान परिणाम हेर्न सक्नुहुन्छ।
                    </p>
                    <!-- Search -->
                    <form method="GET" action="{{ Route('elections.ResultDistrict', $election->id) }}" class="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto mt-2">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="border-t hover:bg-blue-50">
                                                ...
                                                <td class="p-4  space-x-2">
                                                    <a href="{{ Route('UserChairperson.result', ['id' =>$ward->id, 'e_id' => $election->id]) }}" class="px-3 py-1 bg-blue-400 hover:bg-blue-500 text-white rounded text-xs">
                                                        View
                                                    </a>
                                                </td>
                                            </tr>
