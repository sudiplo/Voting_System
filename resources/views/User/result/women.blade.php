<x-top-layout>
        ...
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
            <div>
                <h1 class="text-2xl font-extrabold text-gray-800 tracking-tight">
                    <span class="text-indigo-600">महिला सदस्य</span>
                </h1>
    ...
    <div id="candidateDropdown" class="z-10 hidden bg-white border border-gray-200 rounded-lg shadow-lg w-44">
        <ul class="p-2 text-sm font-medium text-gray-600"
            ...
            {{-- <li>
                <a href="{{ Route('Usermayor.result', ['id' => $ward->palika->id, 'e_id' => $e->id]) }}"
            ...
            <li>
                <a href="{{ Route('UserChairperson.result', ['id' =>$ward->id, 'e_id' => $e->id]) }}"
                class="block px-4 py-2 rounded hover:bg-indigo-50 hover:text-indigo-600">
                    Chairperson
                </a>
            </li>
            ...
            <li>
                <a href="{{ Route('UserMember.result', ['id' =>$ward->id, 'e_id' => $e->id]) }}"
                class="block px-4 py-2 rounded hover:bg-indigo-50 hover:text-indigo-600">
                    Member
                </a>
            </li>
            ...
            <li>
                <a href="{{ Route('UserWomen.result', ['id' =>$ward->id, 'e_id' => $e->id]) }}"
                class="block px-4 py-2 rounded hover:bg-indigo-50 hover:text-indigo-600">
                    Women
                </a>
            </li>
            ...
            <li>
                <a href="{{ Route('UserDalit.result', ['id' =>$ward->id, 'e_id' => $e->id]) }}"
                class="block px-4 py-2 rounded hover:bg-indigo-50 hover:text-indigo-600">
                    Dalit
                </a>
            </li>
    ...
    @foreach ($candidate as $c)
        <div class=" w-full max-w-md mx-auto bg-white border border-gray-200 rounded-2xl shadow-lg p-5">
            ...
            <a href="{{ Route('UsercandidateProfile',['id' => $c->id, 'e_id' => $e->id]) }}" class="block w-full text-center px-4 py-2 text-sm font-semibold bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition">
                    View Full Profile
            </a>
        </div>
    @endforeach
