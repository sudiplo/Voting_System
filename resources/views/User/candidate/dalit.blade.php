        ...
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
            <div>
                <h1 class="text-2xl font-extrabold text-gray-800 tracking-tight">
                    <span class="text-indigo-600">दलित सदस्य</span> उम्मेदवारहरू
                </h1>
                ...
                <!-- Search -->
                <form method="GET" action="{{ Route('UsercandidateDalit_search', ['id' => $ward->palika->id, 'e_id' => $e->id]) }}" class="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto mt-2">
                    <div class="relative w-full sm:w-96">
                        <input
                            type="text"
                            name="search"
                            value="{{ request('search') }}"
                            placeholder="Search Dalit Candidate"
