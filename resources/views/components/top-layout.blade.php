    ...
    <nav class="flex justify-between items-center px-10 py-3 bg-blue-700 text-white">
        ...
        <div id="dropdownInformation" class="z-10 hidden bg-[#F7F9FC] text-black bg-neutral-primary-medium border border-default-medium rounded-base shadow-lg w-72">
            ...
            <li class="hover:text-blue-600">
                <a href="{{ Route('user.profile') }}" class="inline-flex items-center w-full p-2 hover:bg-neutral-tertiary-medium hover:text-heading rounded">
            ...
            <li class="hover:text-blue-600">
                <a href="{{ Route('user.profile.edit') }}" class="inline-flex items-center w-full p-2 hover:bg-neutral-tertiary-medium hover:text-heading rounded">
