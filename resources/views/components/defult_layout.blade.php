    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="w-70 bg-white shadow-panel flex flex-col overflow-y-auto">
            ...
            <nav class="flex-1 px-4 py-6 text-sm space-y-1">
                ...
                <a href="{{ Route('voters.view') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-gray-100">
                    ✅ Voter Monitoring
                </a>
                ...
                <a href="{{ Route('education-degrees.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-gray-100">
                    🎓 Education
                </a>
